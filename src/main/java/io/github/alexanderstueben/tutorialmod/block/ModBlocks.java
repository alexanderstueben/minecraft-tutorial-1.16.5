...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> AMETHYST_FENCE = registerBlocks("amethyst_fence",
            () -> new FenceBlock(
                    AbstractBlock.Properties.of(Material.METAL)
                            .harvestLevel(2)
                            .harvestTool(ToolType.PICKAXE)
    ...
    public static final RegistryObject<Block> AMETHYST_FENCE_GATE = registerBlocks("amethyst_fence_gate",
            () -> new FenceGateBlock(
                    AbstractBlock.Properties.of(Material.METAL)
                            .harvestLevel(2)
                            .harvestTool(ToolType.PICKAXE)
    ...
    private static <T extends Block> void registerBlockItem(String name, RegistryObject<T> block) {
        ModItems.ITEMS.register(name,
                () -> new BlockItem(block.get(), new Item.Properties().tab(ModItemGroup.TUTORIAL_GROUP)));
    }
